    ...
    def unsupervised_learning(self, X, N_iters):
        ...
        for itera in range(N_iters):
            ...
            for t1 in range(len(X)):
                ...
                # print("Iteration: {0}; Checkpoint#1.0: at {1:.3f}s".format(str(itera+1), time()-startTime))

                for t2 in range(1, M + 1):
                    p1 = np.zeros(self.L)

                    # E step - Compute p1
                    p1 = alphas[t2] * betas[t2]
                ...
                # print("Iteration: {0}; Checkpoint#1.1: at {1:.3f}s".format(str(itera+1), time()-startTime))
                ...
                # print("Iteration: {0}; Checkpoint#1.2: at {1:.3f}s".format(str(itera+1), time()-startTime))
            ...
            print("Iteration: #{0:3d}; Took {1:.2f}s".format(itera + 1, time() - startTime))
        pass
